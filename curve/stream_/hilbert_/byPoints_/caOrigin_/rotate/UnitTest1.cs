...
namespace nilnul.geometry._planar_._TEST_.curve.stream_.hilbert_.byPoints_.aroundOrigin_.rotate
{
	[TestClass]
	public class UnitTest1
	{
		...
		public void TestMethod1(int ord)
		{
			...
			using (var g= Graphics.FromImage(img) )
			{
				...
				geometry.planar.curve.stream_.hilbert_.byPoints_.caOrigin_._ByRotateX.Draw(
					g,
