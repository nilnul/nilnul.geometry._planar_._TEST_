...
namespace nilnul.geometry.planar.curve_.cog_.hypocycl_.frac
{
	[TestClass]
	public class UnitTest1
	{
		...
		public void TestMethod1()
		{
			...
			var period = Math.PI * 2 *
				...
				21 +10;/// the rational; maybe
					/// todo: the proportion as a quotient in the model; If 	k=R/r is a rational number, say	expressed as irreducible fraction, then the curve has R 	cusps.
			...
			for (double i = 0; i < period; i += nilnul.geometry.planar._rotation.unit_.Deg4dbl.MAGNITUDE*4)
			{
