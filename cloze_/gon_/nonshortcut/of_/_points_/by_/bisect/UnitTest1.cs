...
namespace nilnul.geometry.planar.cloze_.gon_.nonshortcut.of_._points_.by_.bisect
{
	public class UnitTest1
	{
		static public System.Collections.Generic.IEnumerable<Complex> TestMethod1()
		{
			...
			var gon = planar.cloze_.gon_.nonshortcut.of_._points_.by_._ByBisectX._OfPoints_0dwelt(
				ps
			);
