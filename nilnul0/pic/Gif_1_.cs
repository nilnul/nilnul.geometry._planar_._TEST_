...
namespace nilnul.pic
{
	...
	/// </summary>
	public class Gif_1_ : IDisposable, IEnumerable<Image>
	{
		...
		public Gif_1_() { DefaultFrameDelay = 500; }



		public Gif_1_(Stream InStream, int Repeat = 0, int Delay = 500)
		{
		...
		///
		/// If the repeat parameter is set to "0" or "none", the GIF will play only once and not loop at all.
		/// Most commonly, a "repeat parameter" can be set to "infinite" which means the GIF will play continuously without stopping.
		///
