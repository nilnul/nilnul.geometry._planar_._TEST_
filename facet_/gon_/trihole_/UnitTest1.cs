...
namespace nilnul.geometry.planar.facet_.gon_.trihole_
{
	[TestClass]
	public class UnitTest1
	{
		...
		static public nilnul.geometry.planar.facet_.Gon4dbl Facet()
		{
			...
			var holeDown = hole_.gon_.eg_.lower1center_.UnitTest1.Hole();

		

			var facet = new nilnul.geometry.planar.facet_.Gon4dbl(hull,hole,holeOther,holeDown);
